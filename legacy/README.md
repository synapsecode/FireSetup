...
* Python's requests library (if not, run pip3 install requests and you should be good to go)
...
* pip install the requests library for python (pip install requests)
